...
fun Thumbnail.toThumbnail(): app.ice.harmoniqa.data.model.searchResult.songs.Thumbnail {
    return app.ice.harmoniqa.data.model.searchResult.songs.Thumbnail(
...
fun List<Thumbnail>.toListThumbnail(): List<app.ice.harmoniqa.data.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<app.ice.harmoniqa.data.model.searchResult.songs.Thumbnail>()
    this.forEach {
        ...
        HomeItem(
            ...
            contents = explore.released.map {
                Content(
                    ...
                    browseId = it.id,
                    thumbnails = listOf(
                        app.ice.harmoniqa.data.model.searchResult.songs.Thumbnail(
                            522,
                            it.thumbnail,
                            522
                        )
