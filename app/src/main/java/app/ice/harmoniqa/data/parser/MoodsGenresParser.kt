...
import app.ice.harmoniqa.data.model.explore.mood.genre.ItemsSong
import app.ice.harmoniqa.data.model.explore.mood.genre.Title
import app.ice.harmoniqa.data.model.explore.mood.moodmoments.Content
        ...
        if (items != null) {
            for (item in items) {
                if (item.musicCarouselShelfRenderer != null) {
                    ...
                    val listContent: MutableList<app.ice.harmoniqa.data.model.explore.mood.genre.Content> = mutableListOf()
                    if (!contents.isNullOrEmpty()) {
                        for (content in contents) {
                            if (content.musicResponsiveListItemRenderer != null) {
                                //Song
                                ...
                                val playlistBrowseId =
                                    content.musicTwoRowItemRenderer?.navigationEndpoint?.browseEndpoint?.browseId
                                listContent.add(
                                    app.ice.harmoniqa.data.model.explore.mood.genre.Content(
                                        playlistBrowseId = playlistBrowseId ?: "",
